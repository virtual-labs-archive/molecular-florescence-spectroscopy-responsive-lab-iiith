...
function scan(){
        ...
        if(step_no==10){
            ...
            document.getElementById("demo").innerHTML = "Step-No 12 : Select the Emission Scan Mode on the screen. On the screen, enter the Excitation wavelength: 350 nm, Emission Start Wavelength: 355 nm and Emission End wavelength: 475 nm. One chooses the Excitation Slit(nm) and Emission Slit(nm) values (here 2.5 nm/2.5 nm) and the scan speed value (here medium ) also.";            
            step_no++;
        }
        // else if(step_no==13){
