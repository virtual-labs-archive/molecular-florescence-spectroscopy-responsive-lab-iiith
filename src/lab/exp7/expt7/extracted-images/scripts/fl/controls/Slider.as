package fl.controls
{
   ...
   public class Slider extends UIComponent implements IFocusManagerComponent
   {
      ...
      public function set direction(param1:String) : void
      {
         ...
         if(Boolean(_loc2_) && Boolean(componentInspectorSetting))
         {
            if(rotation % 90 == 0)
            {
               setScaleY(-1);
      ...
      protected function doSetValue(param1:Number, param2:String = null, param3:String = null, param4:int = undefined) : void
      {
         ...
         if(_loc5_ != _value && (Boolean(liveDragging) && param3 != null || param2 == InteractionInputType.KEYBOARD))
         {
      ...
      override protected function keyDownHandler(param1:KeyboardEvent) : void
      {
         ...
         if(param1.keyCode == Keyboard.DOWN && !_loc4_ || param1.keyCode == Keyboard.LEFT && Boolean(_loc4_))
         {
            _loc3_ = value - _loc2_;
         }
         else if(param1.keyCode == Keyboard.UP && !_loc4_ || param1.keyCode == Keyboard.RIGHT && Boolean(_loc4_))
         {
            _loc3_ = value + _loc2_;
         }
         else if(param1.keyCode == Keyboard.PAGE_DOWN && !_loc4_ || param1.keyCode == Keyboard.HOME && Boolean(_loc4_))
         {
            _loc3_ = minimum;
         }
         else if(param1.keyCode == Keyboard.PAGE_UP && !_loc4_ || param1.keyCode == Keyboard.END && Boolean(_loc4_))
         {
            _loc3_ = maximum;
         }
         if(!isNaN(_loc3_))
