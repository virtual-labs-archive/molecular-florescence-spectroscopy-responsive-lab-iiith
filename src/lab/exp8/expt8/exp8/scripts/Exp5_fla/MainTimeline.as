package Exp5_fla
{
   ...
   public dynamic class MainTimeline extends MovieClip
   {
      ...
      public function solventchange(param1:Event) : *
      {
         ...
         switch(this.switchValue)
         {
            default:
               ...
               this.curcum.curcumin_txt.text = "Rhodamine B Solution";
               this.solutionflask_mc.gotoAndStop(1);
               this.liqud_mc.gotoAndStop(1);
               this.inst_txt.htmlText = "Click on the volumetric flask containing Rhodamine B solution to take it to the instrument table.";
               break;
            case 2:
               trace("two");
               new Tween(this.solutionflask_mc.solution_mc,"alpha",Strong.easeInOut,0,1,1,true);
               this.solution_btn.mouseEnabled = true;
               this.curcum.curcumin_txt.text = "Rhodamine 6G  Solution";
               new Tween(this.curcum,"alpha",Strong.easeInOut,0,1,1,true);
               this.solutionflask_mc.gotoAndStop(2);
               this.liqud_mc.gotoAndStop(2);
               this.inst_txt.htmlText = "Click on the volumetric flask containing Rhodamine 6G solution to take it to the instrument table.";
         }
      }
      ...
      public function takingsolution(param1:MouseEvent) : *
      {
         ...
         this.inst_txt.text = "Click on the quartz cuvette (path length, 1 cm ×1 cm) to take it to the instrument table. Quartz cuvettes for spectrophotometric measurements are transparent only on two opposite sides, unlike the all-side transparent quartz cuvettes used for fluorescence measurements.";
      }
      ...
      public function closelid(param1:MouseEvent) : *
      {
         ...
         this.inst_txt.text = "Open the measurement set-up screen by clicking on the spectrophotometer icon on the computer monitor. ";
      }
      ...
      public function graphshow(param1:MouseEvent) : *
      {
         ...
         {
            this.inst_txt.text = "On the screen, enter the wavelength range. \tStart: 580 nm End: 460 nm. In real operation, the wavelength range of incident light for the sample is chosen and the wavelength scan is run via the accompanied computer software. One can run the scan in absorbance (A) or transmittance (%T) mode. Click on the green Start button on the measurement set-up screen to run the wavelength scan. Observe the wavelength scan.";
         }
         else if(this.solvent.value == 2)
         {
            this.inst_txt.text = "On the screen, enter the wavelength range. \tStart: 580 nm End: 440 nm. In real operation, the wavelength range of incident light for the sample is chosen and the wavelength scan is run via the accompanied computer software. One can run the scan in absorbance (A) or transmittance (%T) mode. Click on the green Start button on the measurement set-up screen to run the wavelength scan. Observe the wavelength scan.";
         }
      }
      ...
      {
         if(this.scanscreen.t1.text == "580" && this.scanscreen.t2.text == "460")
         {
      ...
      {
         if(this.scanscreen.t1.text == "580" && this.scanscreen.t2.text == "440")
         {
            new Tween(this.scanscreen,"alpha",Strong.easeInOut,1,0,1,true);
            this.sysgraph_mc.alpha = 1;
            this.sysgraph_mc.x = 443.95;
      ...
      public function powerons(param1:MouseEvent) : *
      {
         ...
         this.inst_txt.text = "click on the lid to open";
      }
      ...
      public function openlid(param1:MouseEvent) : *
      {
         ...
         this.inst_txt.text = "To place the cuvette in the sample holder, click on the cuvette.";
      }
      ...
      public function cuvettereturn(param1:MouseEvent) : *
      {
         ...
         this.inst_txt.text = "click on the lid to Close";
      }
      ...
      public function closelid3(param1:MouseEvent) : *
      {
         ...
         this.arrow_mc.x = 584.15;
         this.arrow_mc.y = 231.2;
         this.inst_txt.text = "Open the instrument set-up screen by clicking on the fluorescence measurement icon on the computer monitor. ";
      }
      
      public function graphshow2(param1:MouseEvent) : *
      {
         this.play();
         this.inst_txt.text = "Select the Emission Scan Mode on the screen.On the screen, enter the Excitation wavelength: 535 nm, Emission Start Wavelength: 500 nm and Emission End wavelength: 680 nm. One chooses the Excitation Slit(nm) and Emission Slit(nm) values (here 2.5 nm/2.5 nm) and the scan speed value (here \'medium\')";
      }
      ...
      public function scan2close(param1:MouseEvent) : *
      {
         ...
         this.sysgraph_btn.mouseEnabled = true;
         this.inst_txt.text = "On the screen, enter the Excitation wavelength: 535 nm, Emission Start Wavelength: 500 nm and Emission End wavelength: 680 nm. One chooses the Excitation Slit(nm) and Emission Slit(nm) values (here 2.5 nm/2.5 nm) and the scan speed value (here \'medium\')";
      }
      ...
      public function showscreen2(param1:MouseEvent) : *
      {
         ...
         this.sysgraph_btn.mouseEnabled = false;
         this.inst_txt.text = "On the emission measurement screen, enter the Excitation wavelength: 535 nm, Emission Start Wavelength: 500 nm and Emission End wavelength: 680 nm.";
      }
