...
function moveFlask(){
        if(step_no == 0){
            ...
            if(empty_flask == "images/empty-round-bottom-flask.png")
            {
...
function movePipette() {
        if(step_no == 2){
            ...
            if(sol_name == 0){
                img.src = "images/half-filled-anthracene_solution.png"
            }
            else{
                img.src = "images/half-filled-quinine-sol.png"
            }
