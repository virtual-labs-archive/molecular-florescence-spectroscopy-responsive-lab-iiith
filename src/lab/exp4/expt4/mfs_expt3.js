...
function setSolution(){
      ...
      if(sol_name == 0){
        document.getElementById("solution_name").src = "image-specific/anthracene.png";
        document.getElementById("round-bottom-flask").src = "image-specific/anthracene_solution.png"
      }
      else if(sol_name == 1){
        document.getElementById("solution_name").src = "image-specific/quinine.png";
        document.getElementById("round-bottom-flask").src = "image-specific/quinine_solution.png"   
      }
...
function scan(){
        if(step_no==11){
            ...
            if(sol_name == 0){
                ...
                graph_instruction.innerHTML = "On the  absorption measurement screen enter the wavelength range:Start:600nm End:260nm.";
            }
        }
    }
