package Exp3_fla
{
   ...
   public dynamic class MainTimeline extends MovieClip
   {
      ...
      {
         super();
         addFrameScript(0,this.frame1,24,this.frame25,28,this.frame29,48,this.frame49,84,this.frame85,130,this.frame131,135,this.frame136,136,this.frame137,148,this.frame149,159,this.frame160);
      ...
      public function solventchange(param1:Event) : *
      {
         ...
         switch(this.switchValue)
         {
            default:
               ...
               this.liqud_mc.gotoAndStop(1);
               this.sysgraph_mc.gotoAndStop(1);
               this.inst_txt.htmlText = "Click on the volumetric flask containing anthracene solution to take it to the instrument table.";
               break;
            case 2:
               trace("two");
               new Tween(this.solutionflask_mc.solution_mc,"alpha",Strong.easeInOut,0,1,1,true);
               this.solution_btn.mouseEnabled = true;
               this.curcum.curcumin_txt.text = "Quinine sulfate Solution";
               new Tween(this.curcum,"alpha",Strong.easeInOut,0,1,1,true);
               this.solutionflask_mc.gotoAndStop(2);
               this.liqud_mc.gotoAndStop(2);
      ...
      public function takingsolution(param1:MouseEvent) : *
      {
         ...
         this.inst_txt.htmlText = "Click on the quartz cuvette (path length, 1 cm ×1 cm) to take it to the instrument table. Quartz cuvettes for spectrophotometric measurements are transparent only on two opposite sides, unlike the all-side transparent quartz cuvettes used for fluorescence measurements.";
      }
      ...
      public function dropsol(param1:MouseEvent) : *
      {
         ...
         this.play();
         this.inst_txt.htmlText = "To start the absorption spectral scan, click on the pop-up \'Start Absorption Measurement\'.";
      }
      
      public function gotoabsorptionmesur(param1:MouseEvent) : *
      {
         this.play();
         this.inst_txt.htmlText = "Turn on the spectrophotometer by clicking on the power button. In real operation, it takes approx. 30 min for initialization of the instrument.";
      }
      ...
      public function POWERON(param1:MouseEvent) : *
      {
         ...
         this.inst_txt.htmlText = "Open the lid of the sample chamber of the spectrophotometer by clicking on the lid for placing the sample in the cell-holder. ";
      }
      ...
      public function lidopen(param1:MouseEvent) : *
      {
         ...
         this.inst_txt.htmlText = "Click on the cuvette to place it in the sample holder. One has to use pure solvent as the sample blank or reference in this measurement. Here a double beam spectrophotometer is shown.";
      }
      ...
      public function takesolvent(param1:MouseEvent) : *
      {
         ...
         this.inst_txt.htmlText = "Close the chamber lid by clicking on it.";
      }
      ...
      public function closelid(param1:MouseEvent) : *
      {
         ...
         this.inst_txt.htmlText = "Open the measurement set-up screen by clicking on the absorption measurement icon on the computer monitor.";
      }
      ...
      public function graphshow(param1:MouseEvent) : *
      {
         ...
         {
            this.inst_txt.htmlText = "On the screen, enter the wavelength range. \tStart: 620 nm \tEnd: 260 nm. In real operation, the wavelength range of incident light for the sample is chosen and the wavelength scan is run via the accompanied computer software. One can run the scan in absorbance (A) or transmittance (%T) mode.<br> Click on the green Start button on the measurement set-up screen to run the wavelength scan. Observe the wavelength scan.";
         }
         else if(this.solvent.value == 2)
         {
            this.inst_txt.htmlText = "On the absorption measurement screen, enter the wavelength range: Start: 600 nm  End: 260 nm. ";
         }
      }
      ...
      {
         if(this.scanscreen.t1.text == "620" && this.scanscreen.t2.text == "260")
         {
            ...
            this.sysgraph_mc.k1_mc.gotoAndPlay(2);
            this.inst_txt.htmlText = "Click on Close button when spectral scan is complete. In real operation, the scan data are stored in the computer. The instrument stores data and therefore asks for the Results File name. One enters a file name to save the data.";
         }
         else
         {
      ...
      public function forsol2() : *
      {
         if(this.scanscreen.t1.text == "600" && this.scanscreen.t2.text == "260")
         {
            new Tween(this.scanscreen,"alpha",Strong.easeInOut,1,0,1,true);
            this.sysgraph_mc.alpha = 1;
            this.sysgraph_mc.x = 443.95;
      ...
      public function fnclosed(param1:MouseEvent) : *
      {
         ...
         this.inst_txt.htmlText = "To take the cuvette out of the sample chamber, first click on the sample chamber lid to open it and then on the cuvette.";
      }
      ...
      public function lidopend(param1:MouseEvent) : *
      {
         ...
         this.inst_txt.htmlText = "Close the sample chamber lid by clicking on it.";
      }
      ...
      public function closelid2(param1:MouseEvent) : *
      {
         ...
         this.sysgraph_btn.mouseEnabled = false;
         this.play();
         this.inst_txt.htmlText = "Click on the pop-up: \'Start Fluorescence measurement\'.";
      }
      ...
      public function openlid(param1:MouseEvent) : *
      {
         ...
         this.inst_txt.htmlText = "Click on the spectrophotometric quartz cuvette to transfer its content into an all-side-transparent quartz cuvette of path length 1 cm ×1 cm for the fluorescence measurement.";
      }
      ...
      public function closelid3(param1:MouseEvent) : *
      {
         ...
         this.arrow_mc.x = 584.15;
         this.arrow_mc.y = 231.2;
         this.inst_txt.htmlText = "Open the instrument set-up screen by clicking on the fluorescence measurement icon on the computer monitor. ";
      }
      
      public function graphshow2(param1:MouseEvent) : *
      {
         this.play();
         this.inst_txt.htmlText = "Select the Emission Scan Mode on the screen.";
      }
      ...
      public function scan2close(param1:MouseEvent) : *
      {
         ...
         this.sysgraph_btn.mouseEnabled = true;
         this.inst_txt.htmlText = "Collect all data by clicking on the Data tab.";
      }
      ...
      function frame160() : *
      {
         ...
         if(this.solvent.value == 1)
         {
            this.inst_txt.htmlText = "On the screen, enter the Excitation wavelength: 350 nm, Emission Start Wavelength: 360 nm and Emission End wavelength: 650 nm. One chooses judiciously the Exit Slit(nm) and Em Slit(nm) values (here 5 nm/5 nm) and the scan speed value (here Medium) also.  <br>To run the wavelength scan for emission spectrum, click on OK button on the set-up screen. One has to be sure that the solvent blank does not fluoresce in the wavelength range of interest. ";
         }
         else if(this.solvent.value == 2)
         {
            this.inst_txt.htmlText = "On the emission measurement screen, enter the Excitation wavelength: 310 nm, Emission Start Wavelength: 320 nm and Emission End wavelength: 600 nm.";
         }
         this.sysgraph_btn.mouseEnabled = false;
