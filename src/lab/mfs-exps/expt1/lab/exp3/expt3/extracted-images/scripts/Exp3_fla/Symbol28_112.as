package Exp3_fla
{
   ...
   public dynamic class Symbol28_112 extends MovieClip
   {
      ...
      {
         if(this.s1.text == "350" && this.s2.text == "360" && this.s3.text == "650")
         {
      ...
      {
         if(this.s1.text == "310" && this.s2.text == "320" && this.s3.text == "600")
         {
            new Tween(this,"alpha",Strong.easeInOut,1,0,1,true);
            MovieClip(parent).scan2_mc.alpha = 1;
            MovieClip(parent).scan2_mc.x = 443.95;
