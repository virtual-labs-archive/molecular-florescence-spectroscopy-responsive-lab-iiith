...
function moveFlask(){
        if(step_no == 0){
            ...
            if(empty_flask == "image-specific/empty-round-bottom-flask.png")
            {
...
function movePipette() {
        if ( step_no == 2){
            ...
            img.src = "image-specific/half-filled-round-bottom-flask.png"
            // Change to next instruction to be followed.
            ...
            $("#quartz_cuvette").attr("src", "image-specific/cuvette-with-solution.png");
            step_no ++;
