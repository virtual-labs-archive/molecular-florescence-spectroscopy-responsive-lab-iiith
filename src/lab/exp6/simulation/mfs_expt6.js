// This file contains all general functions used in the experiment
    ...
    var images = [];// Two images that are alternated in ordered to get the blinking effect of the spectrometer.
...
function initial_function(){
        ...
        document.getElementById("demo").innerHTML = "Step-No 1: Prepare 10<sup>-3</sup>M, 10<sup>-4</sup>M, 10<sup>-5</sup>M, and 10<sup>-6</sup>M solutions of anthracene in spectroscopic grade cyclohexane. Note that very dilute solutions are not prepared directly. Lower concentration solutions are prepared via dilution of higher concentration solutions.To take a particular solution, first click on the appropriate concentration on the concentration selection bar and then on the volumetric flask. For measurement, start with the most dilute solution first (here, 10<sup>-6</sup>M) and proceed to next higher concentration and so on.";
...
function setSolution(){
      ...
      if(sol_name == 0||sol_name == 1||sol_name == 2||sol_name == 3){
        ...
        document.getElementById("solution_name").src = "images/solname.png";
      }
      document.getElementById("demo").innerHTML = "Step-No 2: Carry out absorption and emission measurements as folllows.Click on the volumetric flask containing anthracene solution to take it to the instrument table.";
}
...
// This method is used to get the clock images, make it visible and rotate the clock hand.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
function clck(){
        // Get the images.
...
function scan(){
        if(step_no==11){
            if(sol_name == 0){
                graph_instruction.innerHTML = "Step-No 13:On the screen enter the wavelength range of spectral scan.  start: 400 nm End: 260 nm. In real operation, the wavelength range of incident light for the sample is chosen and the wavelength scan is run via the accompanied computer software. One can run the scan in absorbance (A)  or transmittance (%T) mode. Click on the green 'start' button on the measurement set-up screen to run the wavelength scan.";
                $(".data_validation, #instruction_bkgd, #graph_instruction").css("visibility", "visible");
            }
            else if(sol_name == 1||sol_name == 2 ||sol_name ==3){
                $(".data_validation1, #popup").css("visibility", "visible");
                document.getElementById("demo").innerHTML = "Step-No 22: On the screen, enter the Excitation wavelength: 360 nm, Emission Start Wavelength: 370 nm and Emission End wavelength: 460 nm. One chooses the Excitation Slit(nm) and Emission Slit(nm) values (here 5 nm/5 nm) and the scan speed value (here “medium”) also.  To run the wavelength scan for emission spectrum, click on 'OK' button on the set-up screen. One has to be sure that the solvent blank does not fluoresce in the wavelength range of interest. ";
            }
        }
...
//This method is used to validate the correct data and display particular graph.This is for absorption spectroscopy.
function startBtn(){
...
//This method is used to validate the correct data and display particular graph.This is for fluriscence spectroscopy.
function okBtn(){
        ...
        // dropdown = document.getElementById("select");
        if(input_1 == 360 && input_2 == 370 && input_3 == 460 && step_no == 22 && sol_name == 0){
        ...
        else if(input_1 == 360 && input_2 == 370 && input_3 == 460 && step_no == 11 && sol_name == 1){
                $(".data_validation1").css("visibility", "hidden");
        ...
        else if(input_1 == 360 && input_2 == 370 && input_3 == 460 && step_no == 11 && sol_name == 2){
                $(".data_validation1").css("visibility", "hidden");
        ...
        else if(input_1 == 360 && input_2 == 370 && input_3 == 460 && step_no == 11 && sol_name == 3){
                $(".data_validation1").css("visibility", "hidden");
...
function disposeGraph(){
        ...
        if(step_no == 23){
            ...
            if(sol_name == 0){
                document.getElementById("demo").innerHTML = "Repeat the emission scan measurements for three other solutions(10<sup>-5</sup>M, 10<sup>-4</sup>M and 10<sup>-3</sup>M).";
            }
            if(sol_name == 1){
                document.getElementById("demo").innerHTML = "Repeat the emission scan measurements for two other solutions(10<sup>-4</sup>M and 10<sup>-3</sup>M).";
            }
            if(sol_name == 2){
                document.getElementById("demo").innerHTML = "Repeat the emission scan measurements for the other solution(10<sup>-3</sup>M).";
            }
            if(sol_name == 3){
                document.getElementById("demo").innerHTML = "Collect the data.";
            }
