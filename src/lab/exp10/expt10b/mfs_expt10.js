...
function scan(){
    ...
    if(step_no==10){
        ...
        document.getElementById("demo").innerHTML = "Step-No 12: Select the Emission Scan Mode on the screen.On the screen, enter the Excitation wavelength: 370 nm, Emission Start Wavelength: 380 nm and Emission End wavelength: 570 nm. One chooses the Excitation Slit(nm) and Emission Slit(nm) values (here 2.5 nm/2.5 nm) and the scan speed value (here medium ) also. ";            
        step_no++;
    }
...
function okBtn(){
    ...
    if(conc_value == 0 && input1 == 370 && input2 == 380 && input3 == 570){
        commonInstructions()
        video1.style.visibility = "visible";
        video1.play();
    }
    else if(conc_value == 1 && input1 == 370 && input2 == 380 && input3 == 570){
        commonInstructions()
        video2.style.visibility = "visible";
        video2.play();
    }
    else if(conc_value == 2 && input1 == 370 && input2 == 380 && input3 == 570){
        commonInstructions()
