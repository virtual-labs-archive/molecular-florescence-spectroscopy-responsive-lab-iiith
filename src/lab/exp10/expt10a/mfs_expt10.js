...
function spectrofluorimeter(){
    if (step_no == 7){
        ...
        images[0] = "../../common_images/specfluor_on_redLight.png";
        images[1] = "../../common_images/specfluor_on_no_redLight.png";
        document.getElementById("demo").innerHTML = "Step-No 11:Open the measurement set-up screen by clicking on the fluorescence measurement icon on the computer monitor.";
...
function okBtn(){
    ...
    else if(conc_value == 1 && input1 == 350 && input2 == 360 && input3 == 570){
        commonInstructions()
        video2.style.visibility = "visible";
        video2.play();
    }
    else if(conc_value == 2 && input1 == 350 && input2 == 360 && input3 == 570){
        commonInstructions()
        video3.style.visibility = "visible";
        video3.play();
    }
    else if(conc_value == 3 && input1 == 350 && input2 == 360 && input3 == 570){
        commonInstructions()
