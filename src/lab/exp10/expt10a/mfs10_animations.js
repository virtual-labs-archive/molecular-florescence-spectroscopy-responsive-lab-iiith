...
function moveFlask(){
    if(step_no==0){ 
        if(conc_value==undefined){
            ...
            /* After the flask is moved on to the table, make the slider disabled and decrease the opacity
             value to make it look lighter.  */
...
function movePipette() {
        if (step_no == 2 && count == 2){
            ...
            $("#round-bottom-flask").attr("src","images/half-filled-flask.png");
