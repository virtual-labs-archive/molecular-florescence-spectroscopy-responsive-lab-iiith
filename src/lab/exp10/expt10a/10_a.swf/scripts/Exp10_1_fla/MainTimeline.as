package Exp10_1_fla
{
   ...
   public dynamic class MainTimeline extends MovieClip
   {
      ...
      {
         this.play();
         this.inst.htmlText = "Select the Emission Scan Mode on the screen.<br>On the screen, enter the Excitation wavelength: 350 nm, Emission Start Wavelength: 360 nm and Emission End wavelength: 570 nm. One chooses the Excitation Slit(nm) and Emission Slit(nm) values (here 2.5 nm/2.5 nm) and the scan speed value (here \'medium\') also.";
      }
      ...
      public function scan2close(param1:MouseEvent) : *
      {
         ...
         this.sysgraph_btn.mouseEnabled = true;
         this.inst.htmlText = "Click on \'Reset\' button to start over the measurements for the other concentrations.";
      }
      ...
      function frame1() : *
      {
         ...
         this.lidopen_mc.alpha = 0;
         this.inst.htmlText = "Prepare a 3 × 10^(-4) M  solution of anthracene in the presence of following concentrations of N,N-diethylaniline in spectroscopic grade toluene. (i) 0 M, (ii) 0.10 M, (iii) 2.5 × 10^(-2) M and (iv)5 × 10^(-3)  M. Here the solutions are shown on the concentration selection bar.";
